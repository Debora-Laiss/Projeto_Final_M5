    ...
    <section className="home"> 
      ...
      <div className="home-container">
        <Box 
          ...
          sx={{ textAlign: 'center', padding: '295px', fontStyle: "Merriweather" }}
        >
          <Typography 
            variant="h1" 
            component="h1" 
          ...
          {showMore && (
            <Typography 
              variant="body1" 
              className="body-font" 
              sx={{ marginTop: '100px', fontStyle: "Merriweather", fontSize: '30px' }}
            >
              ...
              Cada indivíduo com autismo apresenta desafios únicos, ou seja, enquanto alguns conseguem realizar a maioria das atividades de vida diária sem apoio, 
              outros precisam de ajuda até em tarefas consideradas simples.
            </Typography>
          )}
